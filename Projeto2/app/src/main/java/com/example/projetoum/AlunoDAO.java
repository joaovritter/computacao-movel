...
public class AlunoDAO {
    ...
    public void excluir(Aluno a) {
        banco.delete("aluno", "id = ?", new String[] { a.getId().toString() }); // no lugar do ? vai colocar o id do
                                                                                // aluno
    }
    ...
    public boolean validaTelefone(String telefone) {
        ...
        // 3. Verifica se o resultado tem exatamente 11 dígitos e o terceiro dígito é
        // '9'.
    ...
    public boolean validaCpf(String CPF) {
        ...
        // Verifica se o CPF não é uma sequência repetida (como 00000000000,
        // 11111111111, etc.)
        /*
         * \\d Representa qualquer número de 0 a 9
         * (\\d) Captura o primeiro dígito do CPF
         * \\1 Repete o mesmo dígito capturado antes
         * {10} Exige que o mesmo dígito apareça mais 10 vezes, totalizando 11 dígitos
         * iguais
         */
        ...
        try {
            ...
            return (dig10 == (char) (CPF.charAt(9))) && (dig11 == (char) (CPF.charAt(10))); // Verifica se os dígitos
